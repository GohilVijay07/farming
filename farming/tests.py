...
class AgriConnectWeatherTestCase(TestCase):
    ...
    def test_weather_page_render(self):
        ...
        content = response.content.decode()
        self.assertIn("Gujarat Weather", content)
        self.assertIn("Live weather information for farmers across Gujarat", content)
        self.assertIn("Farming Weather Advice", content)
        self.assertIn("5-Day Gujarat Agricultural Forecast", content)
